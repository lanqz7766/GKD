...
distiller = dict(
    ...
    # teacher_pretrained = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/gfl_r101_fpn_mstrain_2x_coco/epoch_24.pth',
    teacher_pretrained = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/coco/faster_rcnn_r101_fpn_2x_coco/epoch_24.pth',
    init_student = True,
