...
def train_detector(model,
    ...
    distiller_cfg = cfg.get('distiller',None) ## added
    if distiller_cfg is None:                 ## added 
        optimizer = build_optimizer(model, cfg.optimizer) ##added
    else:  ##added
        optimizer = build_optimizer(model.module.base_parameters(), cfg.optimizer)  ##added
