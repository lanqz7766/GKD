...
class Distill_DeformableDETRHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(Distill_DeformableDETRHead, self).__init__(
    ...
    def loss_single_teacher_group(self,
        ...
        loss_iou = 0.1*self.loss_iou(
            bboxes, bboxes_gt, bbox_weights, avg_factor=num_total_pos)

        # regression L1 loss
        loss_bbox = 0.1*self.loss_bbox(
